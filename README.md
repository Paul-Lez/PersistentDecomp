...
The Lean code is contained in the directory `PersistentDecomp`. It contains the following
subdirectories:
...
* `DirectSumDecomposition`: contains the direct-sum decomposition API and fibrewise coordinate lemmas.
...
* `MaximalDecompositionExists`: proves that pointwise finite-dimensional persistence modules decompose as a direct sum of indecomposable modules.
